...
const Homepage = () => {
  return (
    <Container maxW='xl' centerContent>
      ...
      m="10px 0 15px 0"
      >
        <Text fontSize='4xl' fontFamily='Sofadi One' color='whitesmoke' textAlign='center'>
          CHATSY
        </Text>
      </Box>
      <Box w="100%" p={4} borderRadius="lg" borderWidth="1px" bg='rgba(0, 0, 0, 0.3)' textColor='white'>
      <Tabs isFitted variant="soft-rounded">
          <TabList mb="1em">
            <Tab width='50%' textColor='white'>Login</Tab>
            <Tab width='50%' textColor='white'>Sign Up</Tab>
          </TabList>
          <TabPanels>
            <TabPanel>
              {<Login />}
